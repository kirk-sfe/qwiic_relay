...
{  
  public:
    ...
    Qwiic_Relay(uint8_t address=SINGLE_DEFAULT_ADDRESS); // I-squared-C Constructor

    bool begin(); // begin function

    bool isConnected(void); // is the device connected to the system?
...
// simple class to manage the differences in I2C address for quad/vs single
struct Qwiic_QuadRelay : public Qwiic_Relay{

  Qwiic_QuadRelay(uint8_t address=QUAD_DEFAULT_ADDRESS): Qwiic_Relay(address){}; // I-squared-C Constructor
};
